...
class PsycTest1Fragment : Fragment() {

    private lateinit var binding: FragmentPsycTest1Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPsycTest1Binding.inflate(inflater, container, false)
        return binding.root
    }
