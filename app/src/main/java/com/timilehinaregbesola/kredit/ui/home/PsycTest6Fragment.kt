...
class PsycTest6Fragment : Fragment() {

    private lateinit var binding: FragmentPsycTest6Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPsycTest6Binding.inflate(inflater, container, false)
        return binding.root
    }
